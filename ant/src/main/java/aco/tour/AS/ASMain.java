...
//		Scenery city = sceneryDao.getCityById("da666bc57594baeb76b3bcf0");
		Scenery city = SceneryUtil.getCityById("da66bc57594baeb76b3bcf0");
		System.out.println("city"+city);
//		ArrayList<Scenery> sceneryList = sceneryDao.getSceneryListById("da666bc57594baeb76b3bcf0");
		ArrayList<Scenery> sceneryList = SceneryUtil.getSceneryListById("da666bc57594baeb76b3bcf0");
		System.out.println("sceneryList"+sceneryList);
		ACO aco = new ACO();
		aco.init(city, sceneryList, (HashMap<String, Hotel>) hotelMap, 10, 2.0, 3.0);
